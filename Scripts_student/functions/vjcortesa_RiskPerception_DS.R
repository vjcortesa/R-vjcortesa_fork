...
original_columns <- colnames(riskperception_results)[6:ncol(riskperception_results)]
...
tryCatch({
   write_xlsx(riskperception_results, paste0(dirname(functionfolder_path),"/data_output/Risk_Perception", "dataset_240924", ".xlsx"))
